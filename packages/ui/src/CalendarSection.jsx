    ...
    <section id="calendario" className="scroll-mt-28 border-b border-line bg-slate-50 py-16 sm:py-20" aria-labelledby="titulo-calendario">
      <div className="mx-auto max-w-content px-5 sm:px-8">
        ...
        <div className="mt-10 flex flex-col gap-4 border-l-4 border-brand-highlight bg-white px-5 py-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <a className="inline-flex min-h-11 shrink-0 items-center gap-2 self-start rounded-lg bg-brand-primary px-5 py-3 font-bold text-white hover:bg-brand-primary/90" href={content.manual_href} rel="noopener noreferrer" target="_blank">{content.manual_label} <ExternalLink aria-hidden="true" size={18}/></a>
        </div>
      </div>
    </section>
  )
